...
Route::get('/register',['uses'=>'FiliereController@register','as'=>'register']);
Route::get('/login',['uses'=>'Controller@login','as'=>'login']);
...
Route::get('/pagelogout',['uses'=>'Controller@pagelogout','as'=>'pagelogout.pagelogout']);
